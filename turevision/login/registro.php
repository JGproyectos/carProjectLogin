<?php
	...
	if(!empty($_POST))
	{
		...
		$activo = 0;
		$tipo_usuario = 2;
		$secret = '6LeS6i4UAAAAAIHxm9O6ZH9Va8KVDYLHYSKf0R-m';//Modificar
					...
					<div class="panel-body" >
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6LeS6i4UAAAAAFAVTP6-AUiBDaRHya_FDQlPAUii"></div> <!-- Modificar -->
							</div>
